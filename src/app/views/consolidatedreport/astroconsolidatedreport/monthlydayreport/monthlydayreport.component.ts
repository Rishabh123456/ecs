...
export class MonthlydayreportComponent implements OnInit, OnDestroy, OnChanges {
  ...
  onYearChnage(){    
    ...
    this.router.navigate(['/astroReports/astrowisereport',this.astroid, this.selectedYear, this.selectedMonth], {relativeTo: this.route});
    }
    onMonthChange(){     
      this.getAstroconsolidatedList(this.selectedYear, this.selectedMonth, this.astroid);
      this.router.navigate(['/astroReports/astrowisereport',this.astroid, this.selectedYear, this.selectedMonth], {relativeTo: this.route});
  ...
  onNavigate(monthReport:Astromonthreport){
    ...
    this.router.navigate([ '/astroReports/astrowisereport',monthReport.astroid, this.selectedYear, this.selectedMonth, monthReport.astroid, monthReport.logging_date]  );
  }
}
