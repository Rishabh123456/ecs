...
export class BannerService {
    ...
    createBanner(dataObject: any) {
        ...
        formData.append('clickable', dataObject.clickable);
        if (dataObject.clickable) {
            formData.append('landingScreenId', dataObject.landingScreenId);
        }
    ...
    updateBanner(bannerDetails: Banner) {
         ...
         _bannerURL = _bannerURL + '/' +  bannerDetails.id + '?active=' +  bannerDetails.active + '&landingScreenId=' +  bannerDetails.landingScreenId+ '&clickable=' +  bannerDetails.clickable ; 
